...
float calculate_Discount(int age, int vip_level, float purchase_amount) {
    ...
    // อายุ 30-40 ปี หรือเป็นสมาชิก VIP ระดับ 2 และยอดซื้อสินค้าเกิน 2000 บาท
    else if ((age >= 30 && age <= 40 || vip_level == 2) && purchase_amount > 2000) {
        discount_rate = 0.15; // ส่วนลด 15%
    }

    // อายุ 18-25 ปี หรือเป็นสมาชิก VIP ระดับ 1 และยอดซื้อสินค้าเกิน 1000 บาท
    else if ((age >= 18 && age <= 25 || vip_level == 1) && purchase_amount > 1000) {
